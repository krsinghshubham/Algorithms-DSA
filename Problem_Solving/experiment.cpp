...
// int powerc(int n, int power)
// {
//   if(power==0)
//   return 1;
//    return n*powerc(n,power-1);
// }
...
int main(int argc, char *argv[])
{
  ...
  while (keepPlay)
  {
    ...
    while (!winner && numMoves < ROWS * COLS)
    {
      ...
      {
        cout << endl
             << "Player 1: Where do you want to play? (1 - 9) P.S. you are Xs: " << endl;
        getline(cin, input);
      ...
      {
        cout << endl
             << "Player 2: Where do you want to play? (1 - 9) P.S. you are Os: " << endl;
        getline(cin, input);
